...
@Service
public class sendUnicodeFlashSmsService {

	@Value("${tubelight.unicode-url}")		private String tubeUnicodeFlashUrl;
	...
	public String sendUnicodeFlashMessage(String message) throws IOException, InterruptedException {

		String finalUrl = UriComponentsBuilder.fromUriString(tubeUnicodeFlashUrl)
							.queryParam("username", tubeUserName)
							.queryParam("password", tubePassword)
							.queryParam("type", tubeTypeUnicodeFlash)
