...
public class salesforceSucessfullRecordsService {
	...
	public salesforceSucessfullRecordsService(salesforceTokenService tokenService) {
		this.tokenservice = tokenService;
	}

	public String getSuccessfulResults(String jobId) throws IOException, InterruptedException {
