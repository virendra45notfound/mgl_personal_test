...
public class salesforceBatchService {
	...
	public JsonNode handleInstance2BatchUpload(String objectName, String csvData,String externalIdFieldName) {
		...
		return completeservice.markUploadCompleteInstance2(accessToken, jobId);
	}
}