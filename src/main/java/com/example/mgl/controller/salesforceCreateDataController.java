...
public class salesforceCreateDataController {
	...
	@PostMapping("/account")
	public ResponseEntity<JsonNode> createSalesforceAccountJob() {
	...
	public ResponseEntity<JsonNode> createSalesforceConnectionJob() {
		JsonNode tokenNode = tokenService.getAccessToken();
		String accessToken = tokenNode.get("access_token").asText();
	...
	@PostMapping("/premise")
	public ResponseEntity<JsonNode> createSalesforcePremiseJob() {
		JsonNode tokenNode = tokenService.getAccessToken();
		String accessToken = tokenNode.get("access_token").asText();
	...
	public ResponseEntity<JsonNode> createSalesforceInstallationJob() {
		JsonNode tokenNode = tokenService.getAccessToken();
		String accessToken = tokenNode.get("access_token").asText();
	...
	public ResponseEntity<JsonNode> createSalesforceContractJob() {
		JsonNode tokenNode = tokenService.getAccessToken();
		String accessToken = tokenNode.get("access_token").asText();
	...
	@PostMapping("/billing")
	public ResponseEntity<JsonNode> createSalesforceBillingJob() {
		JsonNode tokenNode = tokenService.getAccessToken();
		String accessToken = tokenNode.get("access_token").asText();
