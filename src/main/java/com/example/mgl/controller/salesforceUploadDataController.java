...
public class salesforceUploadDataController {
	...
	@Autowired
	public salesforceUploadDataController(salesforceTokenService salesforceTokenService,
	...
	public ResponseEntity<String> uploadJobData(@PathVariable String jobId, @RequestBody String csvData) throws IOException, InterruptedException {
